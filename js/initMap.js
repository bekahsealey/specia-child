jQuery(document).ready(function( $ ) {
    ...
    if(stateData != undefined)
    {
        ...
        $.ajax({
            type: 'GET',
            url: '../../wp-content/themes/specia-child-master/js/mapData.xml',
                    ...
                    if (stateModes[id] != 'OFF') {
                        ...
                        if (useSideText == 'true') {
                            ...
                            if(stateData[id] != undefined)
                            {
                                ...
                                {
                                    console.log("SHOW "+ stateNames[id] + "  " + stateData[i][0])
                                    if(stateNames[id] == stateData[i][0])
                                    {
                                        console.log("SHOW "+ stateNames[id] + "  " + stateData[i][0]);
                                        var html = '<div> <h3>Constitution Party of '+ stateData[i][0]+'</h3><h5>Name: '+stateData[i][1]+'</h5><h5>Address: '+stateData[i][2]+'</h5><h5>Address2: '+stateData[i][3]+'</h5><h5>Phone: '+stateData[i][4]+'</h5><h5>Email: <a href="mailto:'+stateData[i][5]+'">'+stateData[i][5]+ '</a></h5><h5>Website: <a href="http://'+stateData[i][6]+'" target="_blank">'+stateData[i][6]+'</a></h5><button id="closeBtn" class="red">Close</button></div>';
                                        console.log(stateData[i]);
                                        $('#stateInfo').html(html);
                                        $('.state-info-container').fadeIn();
                                        $('.state-info-container').css('margin-bottom', '-'+$('.state-info-container').height()+'px');
                                        $('#stateInfo button').click(function(){$('.state-info-container').fadeOut(); $('.state-info-container').css('margin-bottom', '-'+$('.state-info-container').height()+'px');});
                                        break;
                                    }
                                }
                            ...
                            {
                                $('.state-info-container').fadeOut();
                                $('.state-info-container').css('margin-bottom', '0px');
                            }
