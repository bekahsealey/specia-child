            ...
            <div class="col-md-6 col-sm-7">
				<?php if($hide_show_contact_infos == 'on') { ?>
					...
					<ul class="info pull-right">
						<?php if($header_email) { ?> 
							<li><a href="mailto:<?php echo esc_attr($header_email); ?>"><i class="dashicons dashicons-email"></i> <?php echo $header_email; ?> </a></li>
						<?php } ?>
						
						<?php if($header_contact) { ?> 
							<li><a href="tel:<?php echo esc_attr($header_contact); ?>"><i class="dashicons dashicons-phone"></i> <?php echo $header_contact; ?></a></li>
						<?php } ?>
					</ul>
					<!-- /End Contact Info -->
				<?php } ?>
